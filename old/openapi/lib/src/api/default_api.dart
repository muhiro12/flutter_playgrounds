...
class DefaultApi {
  ...
  Future<Response<BuiltList<String>>> gitignoreTemplatesGet({ 
    ...
    final _path = r'/gitignore/templates';
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse200>> gitignoreTemplatesNameGet({ 
    ...
    final _path = r'/gitignore/templates/{name}'.replaceAll('{' r'name' '}', name.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
